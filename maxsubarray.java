...
public class maxsubarray{
  ...
  public static answer fmaxsubarray(int[] arr, int low, int high){
    ...
    public static answer mixed(int[] arr, int low, int high){
      if (high == low){
  ...
  public static void main(String[] args) {
    ...
    for (int i = 5; i < 251; i+=5 ) {
      int[] x = new int[i];
      for (int j = 0; j < i; j++){
        int y = getRandomNumberInRange(-100, 100);
      //  System.out.println(y);
        x[j] = y;
      }
      alist.add(x);
    }
      long[] brute = new long[50];
      long[] recursive = new long[50];
      long[] mixed = new long[50];

      int count = 0;
      for(int[] nums: alist){

      long startTime = System.nanoTime();
      answer ans = bruteforce(nums);
      long endTime = System.nanoTime();
      long timeElapsed = endTime - startTime;
      brute[count] = startTime/1000000;

      long startTime1 = System.nanoTime();
      answer ans1 = fmaxsubarray(nums, 0, nums.length-1);
      long endTime1 = System.nanoTime();
      long timeElapsed1 = endTime1 - startTime1;
      recursive[count] = startTime1/1000000;

      long startTime2 = System.nanoTime();
      answer ans2 = mixed(nums, 0, nums.length-1);
      long endTime2 = System.nanoTime();
      long timeElapsed2 = endTime2 - startTime2;
      mixed[count] = startTime2/1000000;
    ...
    //
    // long startTime2 = System.nanoTime();
    // answer ans2 = mixed(a, 0, a.length-1);
    // long endTime2 = System.nanoTime();
    // long timeElapsed2 = endTime2 - startTime2;
    //
    //
